...
const { rendersignup, dosignup, renderlogin, renderhome, doLogin, updateprofile, doupdate, viewprofile, viewcompanyjob, viewuserprofile } = require('../controllers/companycontrollers');
